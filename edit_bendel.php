...
$query_bendel = "SELECT * FROM bendel WHERE id = $id_bendel AND id_user_input = " . $_SESSION['user_id'];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $nama_penyetor = mysqli_real_escape_string($conn, trim($_POST['nama_penyetor']));
            ...
            <?php endif; ?>
                ...
                <div class="border-b pb-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="no_bendel" required value="<?php echo htmlspecialchars($bendel['no_bendel']); ?>" class="w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-500">
                    </div>
                
                    <div class="mb-4">
                        <label class="block text-gray-700 font-semibold mb-2">Tanggal Terima *</label>
                        <input type="date" name="tgl_terima" required value="<?php echo $bendel['tgl_terima']; ?>" class="w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="id_kantor_penerima" required 
                            ...
                            <option value="<?php echo $kantor['id']; ?>"
                                    <?php echo $bendel['id_kantor_penerima'] == $kantor['id'] ? 'selected' : ''; ?>>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="tipe_transaksi" required 
                            ...
                            <option value="setoran" <?php echo $transaksi['tipe_transaksi'] == 'setoran' ? 'selected' : ''; ?>>Setoran</option>
                            <option value="penarikan" <?php echo $transaksi['tipe_transaksi'] == 'penarikan' ? 'selected' : ''; ?>>Penarikan</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" name="nomor_mulai" required
                                   value="<?php echo htmlspecialchars($transaksi['nomor_mulai']); ?>"
                                   id="nomor_mulai"
                                   class="w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="nomor_sampai" required
                                   value="<?php echo htmlspecialchars($transaksi['nomor_sampai']); ?>"
                                   id="nomor_sampai"
                                   class="w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_penyetor" required maxlength="100"
                               value="<?php echo htmlspecialchars($transaksi['nama_penyetor']); ?>"
                               class="w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="id_kantor_pengirim" required 
                            ...
                            ?>
                            <option value="<?php echo $kantor['id']; ?>"
                                    <?php echo $transaksi['id_kantor_pengirim'] == $kantor['id'] ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($kantor['nama_kantor']); ?>
                            </option>
                            <?php endwhile; ?>
                        </select>
