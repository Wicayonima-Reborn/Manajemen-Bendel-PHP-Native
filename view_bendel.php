        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6">
            ...
            <form method="GET" class="mb-6">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded font-semibold">Filter</button>
                    <a href="view_bendel.php" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded font-semibold">↻ Reset</a>
                ...
                <table class="w-full text-left">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="px-4 py-3">Nomor Mulai</th>
                            <th class="px-4 py-3">Nomor Selesai</th>
                            <th class="px-4 py-3">Nama Penyetor</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3"><?php echo htmlspecialchars($row['tipe_transaksi']); ?></td>
                            <td class="px-4 py-3"><?php echo htmlspecialchars($row['nomor_mulai']); ?></td>
                            <td class="px-4 py-3"><?php echo htmlspecialchars($row['nomor_sampai']); ?></td>
                            ...
                            <td class="px-4 py-3 text-center flex justify-center gap-2"> 
                                <a href="detail_bendel.php?id=<?php echo $row['id']; ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">Detail</a> <?php if ($role == 'penginput'): ?> 
                                <a href="edit_bendel.php?id=<?php echo $row['id']; ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white  px-3 py-1 rounded text-sm">Edit</a> <?php endif; ?>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
            ...
            <div class="text-center py-8">
                ...
                <a href="add_bendel.php" class="inline-block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded">Tambah Bendel Pertama</a>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        </div>
